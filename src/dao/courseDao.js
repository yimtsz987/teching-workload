...
exports.editCourseInfo = function (options,callback) {
    ...
    var eidtParams = [options.courseNode,options.name,options.formulaType,options.majorNode,options.courseType,options.id];
    connection.query(editCourseSQL,eidtParams,function (err, result) {
        if(err){
